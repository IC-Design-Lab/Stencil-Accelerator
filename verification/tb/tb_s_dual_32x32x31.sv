...
initial begin
 $readmemh("../golden/test_3d_n32_m32_p31_r1_k2_shape_cross/input_ieee754.txt" , input_ram);
  $readmemh("../golden/test_3d_n32_m32_p31_r1_k2_shape_cross/output_ieee754.txt", output_ram);
  $readmemh("../golden/test_3d_n32_m32_p31_r1_k2_shape_cross/weights_ieee754.txt", weights_ram);
...
initial begin
  ...
  wait(~reset);
  `ifdef SC_R1_K2_3D
      report=$fopen("./sc_r1_k2_3d/n32_m32_p31/report.log", "w");
